	 		       ...
	 		       $scope.upload = function (file,fileAdmin,i,y) {
	     			...
	     			$scope.fileGrid = {
 		                ...
 		                columns: [
 		                          ...
 		                          { field:"filename",template:"<a  class='uk-text-primary uk-margin-remove' href='/api/files/1/#:name#.' target='_self' download='#:filename#'>#:filename#</a>", title: "Үйлчлүүлэгчийн загвар" },
