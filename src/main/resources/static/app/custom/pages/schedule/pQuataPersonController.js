    ...
    .controller("quatapersonCtrl", ['$scope', '$timeout', 'user_data', 'mainService', 'sweet', '$state', 'p_cat', 'reason', 'users',
        function ($scope, $timeout, user_data, mainService, sweet, $state, p_cat, reason, users) {
            ...
            var aj = [{"text": "Хувиарлаагүй", "value": "1"}, {
                "text": "Хувиарласан",
                "value": "2"
            }, {"text": "Баталсан", "value": "3"}, {"text": "Баталсан", "value": "5"}, {
                "text": "Баталсан",
                "value": "6"
            }, {"text": "Буцаасан", "value": "4"}];
                        ...
                        if (data.rread === 1) {
                            ...
                            $scope.puserGrid = {
                                dataSource: {
                                    ...
                                    transport: {
                                        read: {
                                            ...
                                            data: {
                                                "custom": "where depid=" + user_data.depid + " and isenabled=1",
                                                "depid": user_data.depid
                                            },
                                            type: "POST"
                                        },
                                ...
                                columns: [
                                    ...
                                    {
                                        field: "director",
                                        title: "Тэргүүлэх аудитор/ Захирал",
                                        filterable: false,
                                        width: 250
                                    },
                                    {
                                        field: "chpos",
                                        title: "Чанарын баталгаажуулалт хийсэн ажилтны албан тушаал",
                                        width: 250
                                    },
                                    {
                                        field: "chname",
                                        title: "Чанарын баталгаажуулалт хийсэн ажилтны овог нэр",
                                        filterable: false,
                                        width: 250
                                    },
                                    {
                                        field: "apos",
                                        title: "Аудит хийсэн ажилтны албан тушаал",
                                        filterable: false,
                                        width: 250
                                    },
                                    {
                                        field: "aname",
                                        title: "Аудит хийсэн ажилтны овог нэр",
                                        filterable: false,
                                        width: 250
                                    }
                                ],
                            ...
                            if (data.rupdate === 1) {
                                $scope.puserGrid.columns.push({
                                    template: kendo.template($('#update').html()),
                                    width: 100
                                })
                            }
                        } else {
