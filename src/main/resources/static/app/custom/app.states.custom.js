        ...
        function ($stateProvider, $urlRouterProvider, $httpProvider) {
            ...
            $stateProvider
                ...
                .state("restricted.work.mainwork", {
                    ...
                    resolve: {
                        ...
                        mainobj: function ($http, $stateParams, $state) {
                            return $http({
                                method: 'GET',
                                url: '/fin/resource/MainAuditRegistration/' + $stateParams.issueId
                            })
                                .then(function (data) {
                                    if (data.data) {
                                        return data.data;
                ...
                .state("restricted.work.accSurvey", {
                    ...
                    resolve: {
                        ...
                        app_data: function ($http, $stateParams) {
                            return $http({
                                method: 'GET',
                                url: '/fin/resource/MainAuditRegistration/' + $stateParams.planid
                            })
                                .then(function (data) {
                                    return data.data;
                                })
                ...
                .state("restricted.pages.quataperson", {
                    ...
                    data: {
                        pageTitle: 'Аудитын хуваарь'
                    },
					ncyBreadcrumb: {
						label: 'Аудитын хуваарь'
					}
                })
