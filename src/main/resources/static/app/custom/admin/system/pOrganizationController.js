        ...
        function ($scope, $rootScope, $state, $timeout, user_data, mainService, sweet, p_plan) {
            ...
            $scope.pmenuGrid = {
                ...
                columns: [
                    ...
                    {field: "departmentname", title: "Нэр", width: 200},
                    {field: "shortname", title: "Товчилсон нэр", width: 150},
                    {field: "auditCount", title: "Багц", width: 90, filterable: false},
                    {field: "reg", title: "УБ-н дугаар", width: 150},
                    {field: "address", title: "Хаяг", width: 250},
                    {field: "phone", title: "Утас", width: 150},
