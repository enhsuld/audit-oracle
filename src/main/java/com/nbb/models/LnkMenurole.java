...
public class LnkMenurole implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "MENUROLE_SEQ")
    @SequenceGenerator(sequenceName = "lnk_menurole_seq", allocationSize = 1, name = "MENUROLE_SEQ")
	private long id;
