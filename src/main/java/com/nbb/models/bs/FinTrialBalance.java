...
/**
 * The persistent class for the FIN_TRIAL_BALANCE database table.
 * 
 */
@Entity
@Table(name="fin_trial_balance")
@NamedQuery(name="FinTrialBalance.findAll", query="SELECT f FROM FinTrialBalance f")
public class FinTrialBalance implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "NT2_SEQ")
    @SequenceGenerator(sequenceName = "fin_trial_balance_seq", allocationSize = 1, name = "NT2_SEQ")
	private long id;
