...
/**
 * The persistent class for the FIN_NT2 database table.
 * 
 */
@Entity
@Table(name="fin_nt2")
@NamedQuery(name="FinNt2.findAll", query="SELECT f FROM FinNt2 f")
public class FinNt2 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "NT2_SEQ")
    @SequenceGenerator(sequenceName = "fin_nt2_seq", allocationSize = 1, name = "NT2_SEQ")
	private long id;
