...
/**
 * The persistent class for the FIN_CBWS database table.
 * 
 */
@Entity
@Table(name="fin_cbws")
@NamedQuery(name="FinCbw.findAll", query="SELECT f FROM FinCbw f")
public class FinCbw implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CBWS_SEQ")
    @SequenceGenerator(sequenceName = "fin_cbws_seq", allocationSize = 1, name = "CBWS_SEQ")
	private long id;
