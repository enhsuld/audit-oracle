...
@Entity
@Table(name="fin_ctt6")
@NamedQuery(name="FinCtt6.findAll", query="SELECT f FROM FinCtt6 f")
public class FinCtt6 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT6_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt6_seq", allocationSize = 1, name = "CTT6_SEQ")
	private long id;
