...
@Entity
@Table(name="fin_ctt4")
@NamedQuery(name="FinCtt4.findAll", query="SELECT f FROM FinCtt4 f")
public class FinCtt4 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT4_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt4_seq", allocationSize = 1, name = "CTT4_SEQ")
	private long id;
