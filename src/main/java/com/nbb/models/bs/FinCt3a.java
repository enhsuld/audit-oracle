...
/**
 * The persistent class for the FIN_ST3A database table.
 * 
 */
@Entity
@Table(name="fin_ct3a")
@NamedQuery(name="FinCt3a.findAll", query="SELECT f FROM FinCt3a f")
public class FinCt3a implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CT3A_SEQ")
    @SequenceGenerator(sequenceName = "fin_ct3a_seq", allocationSize = 1, name = "CT3A_SEQ")
	private long id;
