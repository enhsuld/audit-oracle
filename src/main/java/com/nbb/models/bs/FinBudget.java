...
/**
 * The persistent class for the FIN_BUDGET database table.
 * 
 */
@Entity
@Table(name="fin_budget")
@NamedQuery(name="FinBudget.findAll", query="SELECT f FROM FinBudget f")
public class FinBudget implements Serializable {
    ...
    @SequenceGenerator(sequenceName = "fin_budget_seq", allocationSize = 1, name = "BUDGET_SEQ")
	private long id;
