...
/**
 * The persistent class for the FIN_ST4A database table.
 * 
 */
@Entity
@Table(name="fin_ct4a")
@NamedQuery(name="FinCt4a.findAll", query="SELECT f FROM FinCt4a f")
public class FinCt4a implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CT4A_SEQ")
    @SequenceGenerator(sequenceName = "fin_ct4a_seq", allocationSize = 1, name = "CT4A_SEQ")
	private long id;
