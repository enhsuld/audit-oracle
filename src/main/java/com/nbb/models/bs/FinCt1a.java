...
/**
 * The persistent class for the FIN_ST1A database table.
 * 
 */
@Entity
@Table(name="fin_ct1a")
@NamedQuery(name="FinCt1a.findAll", query="SELECT f FROM FinCt1a f")
public class FinCt1a implements Serializable {
	private static final long serialVersionUID = 1L;


	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CT1A_SEQ")
    @SequenceGenerator(sequenceName = "fin_ct1a_seq", allocationSize = 1, name = "CT1A_SEQ")
	private long id;
