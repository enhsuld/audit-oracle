...
@Entity
@Table(name="fin_ctt8")
@NamedQuery(name="FinCtt8.findAll", query="SELECT f FROM FinCtt8 f")
public class FinCtt8 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT8_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt8_seq", allocationSize = 1, name = "CTT8_SEQ")
	private long id;
