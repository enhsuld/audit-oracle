...
@Entity
@Table(name="fin_ctt2")
@NamedQuery(name="FinCtt2.findAll", query="SELECT f FROM FinCtt2 f")
public class FinCtt2 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT2_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt2_seq", allocationSize = 1, name = "CTT2_SEQ")
	private long id;
	...
	public String toString() {
		return "FinCtt2 [id=" + id + ", data1=" + data1 + ", data2=" + data2 + ", data3=" + data3 + ", data4=" + data4
				+ ", data5=" + data5 + ", data6=" + data6 + ",  orgcatid=" + orgcatid
				+ ", orgcode=" + orgcode + ", cyear=" + cyear + ", planid=" + planid + ", stepid=" + stepid
				+ ", mainAuditRegistration=" + mainAuditRegistration + "]";
	}
