...
/**
 * The persistent class for the FIN_CTT1 database table.
 * 
 */
@Entity
@Table(name="fin_ctt1")
@NamedQuery(name="FinCtt1.findAll", query="SELECT f FROM FinCtt1 f")
public class FinCtt1 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT2_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt1_seq", allocationSize = 1, name = "CTT2_SEQ")
	private long id;
