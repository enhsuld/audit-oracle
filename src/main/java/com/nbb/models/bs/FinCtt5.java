...
/**
 * The persistent class for the FIN_CTT4 database table.
 * 
 */
@Entity
@Table(name="fin_ctt5")
@NamedQuery(name="FinCtt5.findAll", query="SELECT f FROM FinCtt5 f")
public class FinCtt5 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT5_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt5_seq", allocationSize = 1, name = "CTT5_SEQ")
	private long id;
