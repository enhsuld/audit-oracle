...
/**
 * The persistent class for the FIN_CTT2 database table.
 * 
 */
@Entity
@Table(name="fin_ctt3")
@NamedQuery(name="FinCtt3.findAll", query="SELECT f FROM FinCtt3 f")
public class FinCtt3 implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CTT3_SEQ")
    @SequenceGenerator(sequenceName = "fin_ctt3_seq", allocationSize = 1, name = "CTT3_SEQ")
	private long id;
