...
/**
 * The persistent class for the FIN_TGT1A database table.
 * 
 */
@Entity
@Table(name="fin_tgt1a")
@NamedQuery(name="FinTgt1a.findAll", query="SELECT f FROM FinTgt1a f")
public class FinTgt1a implements Serializable {
	private static final long serialVersionUID = 1L;
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TGT1A_SEQ")
    @SequenceGenerator(sequenceName = "fin_tgt1a_seq", allocationSize = 1, name = "TGT1A_SEQ")
	private long id;
