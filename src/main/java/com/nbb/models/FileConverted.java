...
public class FileConverted implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CONVERT_SEQ")
    @SequenceGenerator(sequenceName = "file_converted_seq", allocationSize = 1, name = "CONVERT_SEQ")
	private long id;
	private String name;
	@Column(name="flurl")
